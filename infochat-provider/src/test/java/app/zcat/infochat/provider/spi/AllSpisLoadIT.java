package app.zcat.infochat.provider.spi;
...
class AllSpisLoadIT {
    ...
    private static final List<String> INTERFACE_FQNS = List.of(
            "app.zcat.infochat.core.ingest.Fetcher",
            "app.zcat.infochat.core.ingest.StreamSource",
            "app.zcat.infochat.llm.LlmProvider",
            "app.zcat.infochat.llm.EmbeddingProvider",
            "app.zcat.infochat.messaging.MessagingAdapter",
            "app.zcat.infochat.messaging.TranslationProvider",
            "app.zcat.infochat.messaging.ProgressNotifier");

    private static final List<String> RECORD_FQNS = List.of(
            "app.zcat.infochat.core.ingest.NormalizedPost",
            "app.zcat.infochat.llm.LlmResponse",
            "app.zcat.infochat.llm.EmbeddingResult",
            "app.zcat.infochat.messaging.MessageHandle",
            "app.zcat.infochat.messaging.CapabilityFlags");

    private static final List<String> ENUM_FQNS = List.of(
            "app.zcat.infochat.llm.ModelTask",
            "app.zcat.infochat.messaging.ProgressStage");
