 ...
 * The bot's own ACI is derived at adapter startup from the signal-cli
 * account store under the configured data dir
 * ({@code SignalAccountStore}), not typed by the operator.
 *
