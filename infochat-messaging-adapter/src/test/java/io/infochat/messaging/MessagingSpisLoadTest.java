...
class MessagingSpisLoadTest {
    ...
    void messagingAdapterIsLoadableInterface() throws ClassNotFoundException {
        Class<?> type = Class.forName("io.infochat.messaging.MessagingAdapter");
        assertNotNull(type);
    ...
    void translationProviderIsLoadableInterface() throws ClassNotFoundException {
        Class<?> type = Class.forName("io.infochat.messaging.TranslationProvider");
        assertNotNull(type);
    ...
    void progressNotifierIsLoadableInterface() throws ClassNotFoundException {
        Class<?> type = Class.forName("io.infochat.messaging.ProgressNotifier");
        assertNotNull(type);
    ...
    void progressStageIsLoadableEnumWithSpecMandatedValues() throws ClassNotFoundException {
        Class<?> type = Class.forName("io.infochat.messaging.ProgressStage");
        assertNotNull(type);
    ...
    void messageHandleIsLoadableRecord() throws ClassNotFoundException {
        Class<?> type = Class.forName("io.infochat.messaging.MessageHandle");
        assertNotNull(type);
    ...
    void capabilityFlagsIsLoadableRecord() throws ClassNotFoundException {
        Class<?> type = Class.forName("io.infochat.messaging.CapabilityFlags");
        assertNotNull(type);
