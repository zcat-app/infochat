...
- [Qwen3.8 spec-dec landscape (2026-08-27)](qwen38-specdec-landscape.md) — Vulkan spec-decode benchmarks before llama.cpp PR #27812 are INVALID (#27805 graph-optimizer bug, wrong output at temp 0); DFlash2 merged to staging branch `xsn/dflash2`, not master, with open correctness bugs (#27407/#27408); DFlash2 sidecars exist for dense 27B only, no Flash-Next draft head; `--n-cpu-ffn` is discrete-VRAM-only, no-op on UMA.
