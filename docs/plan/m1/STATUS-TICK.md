...
- M1-928 — Golden-set fixtures for the fused-retrieval eval (complexity: medium, risk: low)
...
- M1-929 — blocked_by: M1-928 (pending)
- M1-930 — blocked_by: M1-928 (pending), M1-929 (pending)
