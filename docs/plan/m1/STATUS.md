...
- M1-621 — Subscription model: implicit-bootstrap corpus, private custom sources, command surface + spec amendment (complexity: high, risk: medium)
...
- M1-622 — blocked_by: M1-621 (pending)
