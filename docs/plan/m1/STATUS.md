...
> **Auto-generated by `/m1-tick status`.** Do not hand-edit. Source of truth is the frontmatter of the files under `/home/infochat/infochat/docs/plan/m1/tickets/`. If this file disagrees with frontmatter, frontmatter wins; re-run `/m1-tick status` to regenerate.
...
|---|---|---|---|
| M1-782 | Asset 24h range can exclude the current price | 2026-08-07 | round 1 APPROVE |
...
- M1-776 — Ingest corrupts post body: escaped punctuation and unstripped HTML
- M1-779 — LLM replies leak prompt scaffolding and markdown to the reader
