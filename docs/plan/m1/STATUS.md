...
- M1-035c — /help command + auto-register-on-first-DM (complexity: medium, risk: medium)
...
- M1-035 — blocked_by: M1-035a (done), M1-035b (done), M1-035c (pending)
