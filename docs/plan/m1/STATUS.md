...
- M1-618 — Chat conversational-refinement recovery: clarifying-question on low-confidence retrieval + surface getReferences as 'more like this' (complexity: medium, risk: low)
