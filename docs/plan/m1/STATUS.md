...
- M1-446 — build: pin the Maven toolchain (wrapper) and add a non-empty-unit-suite tripwire so a silent test-skip can never recur (complexity: medium, risk: low)
